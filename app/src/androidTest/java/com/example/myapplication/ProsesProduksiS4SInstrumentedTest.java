...
public class ProsesProduksiS4SInstrumentedTest {

    // ============================================================
    // Ganti nilai ini sesuai data yang ada di database kamu
    // ============================================================
    private static final String NO_PRODUKSI    = "RA.003103";
    ...
    private static final List<String> NO_ST_LIST         = Arrays.asList("E.507192");
    ...
    public void test_saveNoS4S() {
        ...
        Log.d("PP_TEST", "=== test_saveNoS4S START | requestId=" + requestId);
        ProsesProduksiApi.saveNoS4S(NO_PRODUKSI, TGL_PRODUKSI, NO_S4S_LIST, DATE_TIME,
                "S4SProduksiInputS4S", NO_SPK_TUJUAN, ACTOR_ID, ACTOR_NAME, requestId);
        Log.d("PP_TEST", "=== test_saveNoS4S DONE");
    }

    @Test
    public void test_saveNoST() {
        String requestId = UUID.randomUUID().toString();
        Log.d("PP_TEST", "=== test_saveNoST START | requestId=" + requestId);
        ProsesProduksiApi.saveNoST(NO_PRODUKSI, TGL_PRODUKSI, NO_ST_LIST, DATE_TIME,
                NO_SPK_TUJUAN, ACTOR_ID, ACTOR_NAME, requestId);
        Log.d("PP_TEST", "=== test_saveNoST DONE");
    }

    @Test
    public void test_saveNoMoulding() {
        String requestId = UUID.randomUUID().toString();
        Log.d("PP_TEST", "=== test_saveNoMoulding START | requestId=" + requestId);
        ProsesProduksiApi.saveNoMoulding(NO_PRODUKSI, TGL_PRODUKSI, NO_MOULDING_LIST, DATE_TIME,
                "S4SProduksiInputMoulding", NO_SPK_TUJUAN, ACTOR_ID, ACTOR_NAME, requestId);
        Log.d("PP_TEST", "=== test_saveNoMoulding DONE");
    }

    @Test
    public void test_saveNoFJ() {
        String requestId = UUID.randomUUID().toString();
        Log.d("PP_TEST", "=== test_saveNoFJ START | requestId=" + requestId);
        ProsesProduksiApi.saveNoFJ(NO_PRODUKSI, TGL_PRODUKSI, NO_FJ_LIST, DATE_TIME,
                "S4SProduksiInputFJ", NO_SPK_TUJUAN, ACTOR_ID, ACTOR_NAME, requestId);
        Log.d("PP_TEST", "=== test_saveNoFJ DONE");
    }

    @Test
    public void test_saveNoCC() {
        String requestId = UUID.randomUUID().toString();
        Log.d("PP_TEST", "=== test_saveNoCC START | requestId=" + requestId);
        ProsesProduksiApi.saveNoCC(NO_PRODUKSI, TGL_PRODUKSI, NO_CC_LIST, DATE_TIME,
                "S4SProduksiInputCC", NO_SPK_TUJUAN, ACTOR_ID, ACTOR_NAME, requestId);
        Log.d("PP_TEST", "=== test_saveNoCC DONE");
    }

    @Test
    public void test_saveNoLaminating() {
        String requestId = UUID.randomUUID().toString();
        Log.d("PP_TEST", "=== test_saveNoLaminating START | requestId=" + requestId);
        ProsesProduksiApi.saveNoLaminating(NO_PRODUKSI, TGL_PRODUKSI, NO_LAMINATING_LIST, DATE_TIME,
                "S4SProduksiInputLaminating", NO_SPK_TUJUAN, ACTOR_ID, ACTOR_NAME, requestId);
        Log.d("PP_TEST", "=== test_saveNoLaminating DONE");
    }
    ...
    public void test_deleteNoS4S() {
        String requestId = UUID.randomUUID().toString();
        Log.d("PP_TEST", "=== test_deleteNoS4S START | requestId=" + requestId);
        for (String noS4S : NO_S4S_LIST) {
            ProsesProduksiApi.deleteDataByNoLabel(NO_PRODUKSI, noS4S, ACTOR_ID, ACTOR_NAME, requestId);
            Log.d("PP_TEST", "Deleted: " + noS4S);
        }
        Log.d("PP_TEST", "=== test_deleteNoS4S DONE");
    }

    @Test
    public void test_deleteNoST() {
        String requestId = UUID.randomUUID().toString();
        Log.d("PP_TEST", "=== test_deleteNoST START | requestId=" + requestId);
        for (String noST : NO_ST_LIST) {
            ProsesProduksiApi.deleteDataByNoLabel(NO_PRODUKSI, noST, ACTOR_ID, ACTOR_NAME, requestId);
            Log.d("PP_TEST", "Deleted: " + noST);
        }
        Log.d("PP_TEST", "=== test_deleteNoST DONE");
    }

    @Test
    public void test_deleteNoMoulding() {
        String requestId = UUID.randomUUID().toString();
        Log.d("PP_TEST", "=== test_deleteNoMoulding START | requestId=" + requestId);
        for (String noMoulding : NO_MOULDING_LIST) {
            ...
            Log.d("PP_TEST", "Deleted: " + noMoulding);
        }
        Log.d("PP_TEST", "=== test_deleteNoMoulding DONE");
    }

    @Test
    public void test_deleteNoFJ() {
        String requestId = UUID.randomUUID().toString();
        Log.d("PP_TEST", "=== test_deleteNoFJ START | requestId=" + requestId);
        for (String noFJ : NO_FJ_LIST) {
            ProsesProduksiApi.deleteDataByNoLabel(NO_PRODUKSI, noFJ, ACTOR_ID, ACTOR_NAME, requestId);
            Log.d("PP_TEST", "Deleted: " + noFJ);
        }
        Log.d("PP_TEST", "=== test_deleteNoFJ DONE");
    }

    @Test
    public void test_deleteNoCC() {
        String requestId = UUID.randomUUID().toString();
        Log.d("PP_TEST", "=== test_deleteNoCC START | requestId=" + requestId);
        for (String noCC : NO_CC_LIST) {
            ProsesProduksiApi.deleteDataByNoLabel(NO_PRODUKSI, noCC, ACTOR_ID, ACTOR_NAME, requestId);
            Log.d("PP_TEST", "Deleted: " + noCC);
        }
        Log.d("PP_TEST", "=== test_deleteNoCC DONE");
    }

    @Test
    public void test_deleteNoLaminating() {
        String requestId = UUID.randomUUID().toString();
        Log.d("PP_TEST", "=== test_deleteNoLaminating START | requestId=" + requestId);
        for (String noLaminating : NO_LAMINATING_LIST) {
            ...
            Log.d("PP_TEST", "Deleted: " + noLaminating);
        }
        Log.d("PP_TEST", "=== test_deleteNoLaminating DONE");
    }
    ...
    public void test_saveAll() {
        String requestId = UUID.randomUUID().toString();
        Log.d("PP_TEST", "=== test_saveAll START | requestId=" + requestId);
        ProsesProduksiApi.saveNoS4S(NO_PRODUKSI, TGL_PRODUKSI, NO_S4S_LIST, DATE_TIME,
                "S4SProduksiInputS4S", NO_SPK_TUJUAN, ACTOR_ID, ACTOR_NAME, requestId);
        ProsesProduksiApi.saveNoST(NO_PRODUKSI, TGL_PRODUKSI, NO_ST_LIST, DATE_TIME,
                NO_SPK_TUJUAN, ACTOR_ID, ACTOR_NAME, requestId);
        ...
        ProsesProduksiApi.saveNoLaminating(NO_PRODUKSI, TGL_PRODUKSI, NO_LAMINATING_LIST, DATE_TIME,
                "S4SProduksiInputLaminating", NO_SPK_TUJUAN, ACTOR_ID, ACTOR_NAME, requestId);
        Log.d("PP_TEST", "=== test_saveAll DONE");
    }
    ...
    public void test_deleteAll() {
        String requestId = UUID.randomUUID().toString();
        Log.d("PP_TEST", "=== test_deleteAll START | requestId=" + requestId);
        for (String noS4S : NO_S4S_LIST) {
            ProsesProduksiApi.deleteDataByNoLabel(NO_PRODUKSI, noS4S, ACTOR_ID, ACTOR_NAME, requestId);
            Log.d("PP_TEST", "Deleted: " + noS4S);
        }
        ...
        Log.d("PP_TEST", "=== test_deleteAll DONE");
    }
}
