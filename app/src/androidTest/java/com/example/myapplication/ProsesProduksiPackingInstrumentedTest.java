...
public class ProsesProduksiPackingInstrumentedTest {
    ...
    // ============================================================
    private static final String NO_PRODUKSI   = "IA.000001";
    ...
    public void test_saveNoMoulding() {
        ...
        Log.d("PKG_TEST", "=== test_saveNoMoulding START | requestId=" + requestId);
        ProsesProduksiApi.saveNoMoulding(NO_PRODUKSI, TGL_PRODUKSI, NO_MOULDING_LIST, DATE_TIME,
                "PackingProduksiInputMoulding", NO_SPK_TUJUAN, ACTOR_ID, ACTOR_NAME, requestId);
        Log.d("PKG_TEST", "=== test_saveNoMoulding DONE");
    }

    @Test
    public void test_saveNoCC() {
        String requestId = UUID.randomUUID().toString();
        Log.d("PKG_TEST", "=== test_saveNoCC START | requestId=" + requestId);
        ProsesProduksiApi.saveNoCC(NO_PRODUKSI, TGL_PRODUKSI, NO_CC_LIST, DATE_TIME,
                "PackingProduksiInputCCAkhir", NO_SPK_TUJUAN, ACTOR_ID, ACTOR_NAME, requestId);
        Log.d("PKG_TEST", "=== test_saveNoCC DONE");
    }

    @Test
    public void test_saveNoSanding() {
        String requestId = UUID.randomUUID().toString();
        Log.d("PKG_TEST", "=== test_saveNoSanding START | requestId=" + requestId);
        ProsesProduksiApi.saveNoSanding(NO_PRODUKSI, TGL_PRODUKSI, NO_SANDING_LIST, DATE_TIME,
                "PackingProduksiInputSanding", NO_SPK_TUJUAN, ACTOR_ID, ACTOR_NAME, requestId);
        Log.d("PKG_TEST", "=== test_saveNoSanding DONE");
    }

    @Test
    public void test_saveNoPacking() {
        String requestId = UUID.randomUUID().toString();
        Log.d("PKG_TEST", "=== test_saveNoPacking START | requestId=" + requestId);
        ProsesProduksiApi.saveNoPacking(NO_PRODUKSI, TGL_PRODUKSI, NO_PACKING_LIST, DATE_TIME,
                "PackingProduksiInputBarangJadi", NO_SPK_TUJUAN, ACTOR_ID, ACTOR_NAME, requestId);
        Log.d("PKG_TEST", "=== test_saveNoPacking DONE");
    }
    ...
    public void test_deleteNoMoulding() {
        String requestId = UUID.randomUUID().toString();
        Log.d("PKG_TEST", "=== test_deleteNoMoulding START | requestId=" + requestId);
        for (String noMoulding : NO_MOULDING_LIST) {
            ...
            Log.d("PKG_TEST", "Deleted: " + noMoulding);
        }
        Log.d("PKG_TEST", "=== test_deleteNoMoulding DONE");
    }

    @Test
    public void test_deleteNoCC() {
        String requestId = UUID.randomUUID().toString();
        Log.d("PKG_TEST", "=== test_deleteNoCC START | requestId=" + requestId);
        for (String noCC : NO_CC_LIST) {
            ProsesProduksiApi.deleteDataByNoLabel(NO_PRODUKSI, noCC, ACTOR_ID, ACTOR_NAME, requestId);
            Log.d("PKG_TEST", "Deleted: " + noCC);
        }
        Log.d("PKG_TEST", "=== test_deleteNoCC DONE");
    }

    @Test
    public void test_deleteNoSanding() {
        String requestId = UUID.randomUUID().toString();
        Log.d("PKG_TEST", "=== test_deleteNoSanding START | requestId=" + requestId);
        for (String noSanding : NO_SANDING_LIST) {
            ...
            Log.d("PKG_TEST", "Deleted: " + noSanding);
        }
        Log.d("PKG_TEST", "=== test_deleteNoSanding DONE");
    }

    @Test
    public void test_deleteNoPacking() {
        String requestId = UUID.randomUUID().toString();
        Log.d("PKG_TEST", "=== test_deleteNoPacking START | requestId=" + requestId);
        for (String noPacking : NO_PACKING_LIST) {
            ...
            Log.d("PKG_TEST", "Deleted: " + noPacking);
        }
        Log.d("PKG_TEST", "=== test_deleteNoPacking DONE");
    }
    ...
    public void test_saveAll() {
        String requestId = UUID.randomUUID().toString();
        Log.d("PKG_TEST", "=== test_saveAll START | requestId=" + requestId);
        ProsesProduksiApi.saveNoMoulding(NO_PRODUKSI, TGL_PRODUKSI, NO_MOULDING_LIST, DATE_TIME,
                "PackingProduksiInputMoulding", NO_SPK_TUJUAN, ACTOR_ID, ACTOR_NAME, requestId);
        ProsesProduksiApi.saveNoCC(NO_PRODUKSI, TGL_PRODUKSI, NO_CC_LIST, DATE_TIME,
                "PackingProduksiInputCCAkhir", NO_SPK_TUJUAN, ACTOR_ID, ACTOR_NAME, requestId);
        ...
        ProsesProduksiApi.saveNoPacking(NO_PRODUKSI, TGL_PRODUKSI, NO_PACKING_LIST, DATE_TIME,
                "PackingProduksiInputBarangJadi", NO_SPK_TUJUAN, ACTOR_ID, ACTOR_NAME, requestId);
        Log.d("PKG_TEST", "=== test_saveAll DONE");
    }
    ...
    public void test_deleteAll() {
        String requestId = UUID.randomUUID().toString();
        Log.d("PKG_TEST", "=== test_deleteAll START | requestId=" + requestId);
        for (String noMoulding : NO_MOULDING_LIST) {
            ProsesProduksiApi.deleteDataByNoLabel(NO_PRODUKSI, noMoulding, ACTOR_ID, ACTOR_NAME, requestId);
            Log.d("PKG_TEST", "Deleted: " + noMoulding);
        }
        ...
        Log.d("PKG_TEST", "=== test_deleteAll DONE");
    }
}
