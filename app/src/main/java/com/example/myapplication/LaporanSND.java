...
public class LaporanSND extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_laporan_snd);

        laporan_mutasi_snd = findViewById(R.id.laporan_mutasi_snd);

        username = SharedPrefUtils.getUsername(this);

        laporan_mutasi_snd.setOnClickListener(view -> showLaporanMutasiSND());
