...
public class LaporanBJFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        return inflater.inflate(R.layout.activity_laporan_bj, container, false);
    }

    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        laporan_mutasi_bj = view.findViewById(R.id.laporan_mutasi_bj);

        username = SharedPrefUtils.getUsername(requireContext());

        laporan_mutasi_bj.setOnClickListener(v -> showLaporanMutasiBJ());
