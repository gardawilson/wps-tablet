...
public class S4sData {
    ...
    public String getNoS4S() { return noS4S; }
    ...
    public String getNoSTAsal() { return noSTAsal; }
    ...
    public String getIdWarna() { return idWarna; }

    // Setter methods (opsional, jika diperlukan)
    public void setNoS4S(String noS4S) { this.noS4S = noS4S; }
    ...
    public void setNoSTAsal(String noSTAsal) { this.noSTAsal = noSTAsal; }
    ...
    public void setIdWarna(String idWarna) { this.idWarna = idWarna; }
}