...
public class LaporanFJ extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_laporan_fj);

        laporan_mutasi_fj = findViewById(R.id.laporan_mutasi_fj);

        username = SharedPrefUtils.getUsername(this);

        laporan_mutasi_fj.setOnClickListener(view -> showLaporanMutasiFJ());
