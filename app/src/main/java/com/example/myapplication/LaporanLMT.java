...
public class LaporanLMT extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_laporan_lmt);

        laporan_mutasi_lmt = findViewById(R.id.laporan_mutasi_lmt);

        username = SharedPrefUtils.getUsername(this);

        laporan_mutasi_lmt.setOnClickListener(view -> showLaporanMutasiLMT());
