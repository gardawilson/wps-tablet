...
public class LaporanS4SFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        return inflater.inflate(R.layout.activity_laporan_s4s, container, false);
    }

    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        laporan_mutasi_s4s = view.findViewById(R.id.laporan_mutasi_s4s);

        username = SharedPrefUtils.getUsername(requireContext());

        laporan_mutasi_s4s.setOnClickListener(v -> showLaporanMutasiS4S());
