...
public class LaporanCCA extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_laporan_cca);

        laporan_mutasi_cc = findViewById(R.id.laporan_mutasi_cc);

        username = SharedPrefUtils.getUsername(this);

        laporan_mutasi_cc.setOnClickListener(view -> showLaporanMutasiCC());
