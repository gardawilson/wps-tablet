...
public class LaporanMLD extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_laporan_mld);

        laporan_mutasi_mld = findViewById(R.id.laporan_mutasi_mld);

        username = SharedPrefUtils.getUsername(this);

        laporan_mutasi_mld.setOnClickListener(view -> showLaporanMutasiMLD());
    }
