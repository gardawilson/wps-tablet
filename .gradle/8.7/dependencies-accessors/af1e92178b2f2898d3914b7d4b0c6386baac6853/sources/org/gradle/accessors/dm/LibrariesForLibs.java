...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final SweetalertLibraryAccessors laccForSweetalertLibraryAccessors = new SweetalertLibraryAccessors(owner);
    ...
    /**
     * Dependency provider for <b>bouncycastle</b> with <b>org.bouncycastle:bcprov-jdk15on</b> coordinates and
    ...
    /**
     * Group of libraries at <b>sweetalert</b>
     */
    public SweetalertLibraryAccessors getSweetalert() {
        return laccForSweetalertLibraryAccessors;
    }
    ...
    public static class CameraLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>camerax.version</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class SweetalertLibraryAccessors extends SubDependencyFactory {

        public SweetalertLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>dialog</b> with <b>com.github.zeljko-sweetalert:sweet-alert-dialog</b> coordinates and
         * with version reference <b>sweetalert</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getDialog() {
            return create("sweetalert.dialog");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>paging</b> with value <b>3.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>rxjava</b> with value <b>3.1.7</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>smbj</b> with value <b>0.11.5</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>sweetalert</b> with value <b>1.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getSweetalert() { return getVersion("sweetalert"); }
    ...
    public static class CameraxVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>camerax.version</b> with value <b>1.4.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class ZxingVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>zxing.core</b> with value <b>3.5.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
